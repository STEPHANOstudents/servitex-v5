...
async function main() {
  ...
  // ──────────────────────────────────────────────────────────────────────────
  // USUARIOS DEL SISTEMA (Módulo de Seguridad)
  // ──────────────────────────────────────────────────────────────────────────
  console.log('🌱 Creando usuarios del sistema...');
  const usuariosData = [
    { correo: "karen@servitex.com", nombre: "Karen Madleine Quispe Ricaldi", rol: "PROPIETARIA", password: "Servitex2026!" },
    { correo: "stephano@servitex.com", nombre: "David Stephano Salazar Vasquez", rol: "OPERARIO", password: "Operario2026!" },
    { correo: "maicol@servitex.com", nombre: "Maicol Ore", rol: "OPERARIO", password: "Operario2026!" }
  ];
