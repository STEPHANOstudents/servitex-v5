...
// ---------------------------------------------------------------------------
// Rutas de la API — Módulo de Seguridad (Autenticación)
// ---------------------------------------------------------------------------
...
app.listen(PORT, () => {
  ...
  console.log(`   --- Módulo de Seguridad ---`);
  ...
  console.log(`   --- Módulo de Inteligencia de Negocios (Reportes) ---`);
  console.log(`   GET   http://localhost:${PORT}/api/reportes/consumo-colorantes`);
  console.log(`   GET   http://localhost:${PORT}/api/reportes/fidelidad-clientes`);
  console.log(`   GET   http://localhost:${PORT}/api/reportes/produccion-temporal`);
});
